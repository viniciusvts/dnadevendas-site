            ...
            <div class="icone">
                <svg xmlns="http://www.w3.org/2000/svg" width="38.464" height="38.777" viewBox="0 0 38.464 38.777">
                    <g id="whatsapp_1_" data-name="whatsapp (1)" transform="translate(-1.69)">
                        <path id="Caminho_100" data-name="Caminho 100" d="M19.982.023a19.239,19.239,0,0,0-16.2,27.943L1.742,37.877a.749.749,0,0,0,.906.879l9.712-2.3A19.233,19.233,0,1,0,19.982.023ZM31.57,29.88a15.068,15.068,0,0,1-17.35,2.84l-1.352-.674L6.913,33.457l1.253-6.084-.666-1.3A15.072,15.072,0,0,1,10.274,8.584a15.059,15.059,0,1,1,21.3,21.3Z" transform="translate(0 0)" fill="#fcfcfc"/>
